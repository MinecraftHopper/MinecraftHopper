...
* You will need Java installed. For 1.16 and below, you will need to use Oracle Java/OpenJDK 8. For 1.17, you will need to use Oracle Java/OpenJDK 16. For 1.18 to 1.20.4, you will need to use Oracle Java/OpenJDK 17. For 1.20.5 and above, you will need to use Oracle Java/OpenJDK 21. You can follow this to [install the right version of Java](/help/installing-java/)
